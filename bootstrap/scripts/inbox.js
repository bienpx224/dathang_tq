var Inbox = function () {
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: 'bootstrap/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    var loadCompose = function (el) {
        var url = 'page_inbox_compose.html';
