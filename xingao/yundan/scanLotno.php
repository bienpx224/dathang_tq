...
//显示表单-----------------------------------------------------------------------------------------------------
$headtitle="扫描预出库";$alonepage=1;//单页形式
...
<a href="javascript:history.go(-1)" title="<?=$LG['back']?>"><i class="icon-reply"></i></a> <a href="list.php?status=all" class="gray" target="_parent"><?=$LG['backList']?></a> > <?php }?>
  ...
  <!-- BEGIN PAGE CONTENT-->
  <!---->
  <?php require_once($_SERVER['DOCUMENT_ROOT'].'/xingao/yundan/call/scanLotno_save.php');?>
  <?php require_once($_SERVER['DOCUMENT_ROOT'].'/xingao/yundan/call/scanLotno_form.php');?>
  <?php require_once($_SERVER['DOCUMENT_ROOT'].'/xingao/yundan/call/scanLotno_list.php');?>
  <!---->
