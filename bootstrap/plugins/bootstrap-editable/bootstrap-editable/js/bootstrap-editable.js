    ...
    **/
    ...
    $.fn.editable.defaults = {
        ...
        **Please note**, that delegated targets can't be initialized with `emptytext` and `autotext` options, 
        ...
        <div id="user">
          <!-- empty -->
          <a href="#" data-name="username" autocomplete="off" data-type="text" class="editable-click editable-empty" data-value="" title="Username">Empty</a>
          <!-- non-empty -->
...
(function ($) {
    ...
    Date.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/
        ...
        @default 'x clear'
        **/
        clear: 'clear <i class="icon-remove" style="font-size:12px"></i>'
    });
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl 
        **/         
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn default" type="button"><i class="icon-calendar"></i></button></span></div>',
        /**
        @property inputclass 
        @default 'input-small'
        **/         
...
(function ($) {
    ...
    DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
        ...
        @property tpl 
        **/    
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="icon-th"></i></button></span></div>',
         /**
        @property inputclass 
        @default 'input-medium'
        **/         
