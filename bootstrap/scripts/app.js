...
var App = function () {
    ...
    var handleFixedSidebar = function () {
        ...
        if (menu.parent('.slimScrollDiv').size() === 1) { //销毁现有实例之前更新的高度
            menu.slimScroll({
                destroy: true
            });
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "bootstrap/css/themes/" + color + ".css");
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="/bootstrap/img/ajax-loading.gif" align="">',
