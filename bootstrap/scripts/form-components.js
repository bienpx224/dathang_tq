var FormComponents = function () {
    ...
    var handleWysihtml5 = function () {
        ...
        if ($('.wysihtml5').size() > 0) {
            $('.wysihtml5').wysihtml5({
                "stylesheets": ["bootstrap/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
            });
        }
    }
    ...
    var handleSelect2 = function () {
        ...
        function format(state) {
            ...
            return "<img class='flag' src='bootstrap/img/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
    ...
    var handleMultiSelect = function () {
		...
		//新加:各支持放100个
		for(selectNumber=0;selectNumber<=100;selectNumber++)
		{
			if(document.getElementById("my_multi_select1_"+selectNumber))
			{
			   $('#my_multi_select1_'+selectNumber).multiSelect();
			}
			
			if(document.getElementById("my_multi_select2_"+selectNumber))
			{
				$('#my_multi_select2_'+selectNumber).multiSelect({
					selectableOptgroup: true
				});
			}
			
			if(document.getElementById("my_multi_select3_"+selectNumber))
			{
				
				
				$('#my_multi_select3_'+selectNumber).multiSelect({
					selectableHeader: "<input type='text' class='form-control search-input' autocomplete='off' placeholder='search...'>",
					selectionHeader: "<input type='text' class='form-control search-input' autocomplete='off' placeholder='search...'>",
					afterInit: function (ms) {
						var that = this,
