...
$line=18;$page_line=10;//分页处理,不设置则默认
...
?>
	...
	<li>
		<div class="rebatestore">
			<div class="sjdqOutBorder">
				<div class="sjdqInnerBorder"><img src="<?=ImgAdd($rs['img'.$LT])?>" class="verCenter" onload="AutoResizeImage(272,172,this);"/></div>
				<div class="sjdqTipBox" id="abst">
					<div class="sjdqTip">
						<div class="tipInfo" style="text-align:center">
							<table  style="width:225px;height:180px; line-height:20px;">
								<tr>
									<td valign="middle" align="left">
									<a href="<?=$rs['url'.$LT]?cadd($rs['url'.$LT]):pathLT($rs['path'])?>" target="_blank" title="<?=cadd($rs['title'.$LT])?>">
									<?=cadd($rs['title'.$LT])?><br><?=leng($rs['intro'.$LT],150,"...")?>
									</a></td>
								</tr>
							</table>
						</div>
