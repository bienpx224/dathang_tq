          ...
          <div class="form-group">
            ...
            <div class="col-md-9 has-error">
              <input type="text" class="form-control input-medium" name="username" autocomplete="off" id="username" required 
                        ...
                        placeholder="<?php if($member_reg_lx==1){echo $LG['reg.EmailAccounts'];}elseif($member_reg_lx==2){echo $LG['reg.EmailLimit'];}elseif($member_reg_lx==3){echo $LG['reg.LetterLimit'];}?>">
 ...
 <?php if(1==2){?>         
          ...
          <div class="form-group">
            <label class="control-label col-md-3">
              <?php if($member_reg_lx==1){echo $LG['reg.EmailConfirm'];}else{echo $LG['reg.EmailUsed'];}?>
            </label>
            <div class="col-md-9 has-error">
              <input type="text" class="form-control input-medium" name="email" id="email" required 
                        ...
                        placeholder="<?php if($member_reg_lx==1){echo $LG['reg.EmailRepeat'];}else{echo $LG['reg.EmailUsedIn'];}?>">
...
<?php  if($ON_nickname) /*if($ON_nickname&&1==2)*/{?>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-9">
        ...
        <span class="help-block"><font color="#FF3300"><?=$LG['member.10']//提交后将不可更改?></font></span>
    </div>
</div>
<?php }?>
