<?php
$dhl_wsdlPath = 'https://amsel.dpwn.net/abholportal/gw/lp/schema/1.0/var3ws.wsdl';
$dhl_callPath = 'https://amsel.dpwn.net/abholportal/gw/lp/SoapConnector';
$dhl_callOptions = array();
/*
//备用链接方式:未使用
$dhl_callOptions = array(
    'portalId' => 'xxx',
...
class DHLRequest
{
    ...
    function __construct($url='https://amsel.dpwn.net/abholportal/gw/lp/schema/1.0/var3ws.wsdl',$options = array(), $username = '', $password = '')
    {
