...
LODOP.PRINT_INITA("-5mm","-23mm","232mm","152mm","<?=yundan_print($print_tem)?>-上海邮政套打-吉买转运打印");
LODOP.SET_PRINT_PAGESIZE(1,2320,1520,"");//设置纸张高度宽度 (默认单位为0.1mm,如800=80mm)
LODOP.ADD_PRINT_SETUP_BKIMG("G:\sh_youzheng.jpg");
...
//LODOP.SET_PRINT_STYLEA(0,"FontSize",13);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("48.5mm","135mm","24mm","6mm","<?=cadd($rs['s_name'])?>");//收件人
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
