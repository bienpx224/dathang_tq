...
LODOP.PRINT_INITA("-3.5mm","-19mm","244mm","152mm","<?=yundan_print($print_tem)?>-上海EMS套打-吉买转运打印");
LODOP.SET_PRINT_PAGESIZE(1,2440,1520,"");//设置纸张高度宽度 (默认单位为0.1mm,如800=80mm)
LODOP.ADD_PRINT_SETUP_BKIMG("G:\sh-ems.jpg");
...
LODOP.ADD_PRINT_TEXT("25mm","60mm","12mm","5.03mm","<?=DateYmd(time(),'Y')?>");//	时间年
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
