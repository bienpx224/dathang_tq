...
LODOP.PRINT_INITA("-2mm","-30mm","246mm","152mm","<?=yundan_print($print_tem)?>-顺丰套打-吉买转运打印");
LODOP.SET_PRINT_PAGESIZE(1,2460,1520,"");//设置纸张高度宽度 (默认单位为0.1mm,如800=80mm)
LODOP.ADD_PRINT_SETUP_BKIMG("G:\shunfeng_td.jpg");
LODOP.SET_SHOW_MODE("BKIMG_LEFT",2);
LODOP.SET_SHOW_MODE("BKIMG_TOP",4);
LODOP.SET_SHOW_MODE("BKIMG_WIDTH","246mm");
...
LODOP.ADD_PRINT_TEXT("40mm","95.5mm","19.31mm","9mm","<?=CompanySend('sendZip')?>");//发件邮编
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("44mm","38mm","33.07mm","6.09mm","15921688717");//发件电话
...
//LODOP.SET_PRINT_STYLEA(0,"FontSize",13);
//LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("32mm","58mm","65mm","7mm","<?=CompanySend('sendName')?>");//发件公司
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("40mm","50mm","25mm","7mm","<?=cadd($rs['f_name'])?><?=cadd($mrf['truename'])?>");//发件名字
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("50mm","38mm","80mm","10mm","<?=CompanySend('sendAdd')?>");// 换行\n  发件人发件地址
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");


LODOP.ADD_PRINT_TEXT("129mm","148mm","23mm","7mm","<?php $r=CustomerService($rs['userid']);echo $r[0]."({$r[1]})";?>");//客服代表
LODOP.SET_PRINT_STYLEA(0,"FontSize",13);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("115mm","140mm","16mm","6mm","<?=spr($rs['weight'],2,0,1).$XAwt?>");  //总重量
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
...
//LODOP.SET_PRINT_STYLEA(0,"FontSize",13);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("64mm","65mm","24mm","6mm","<?=cadd($rs['s_name'])?>");//收件人
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("81mm","37mm","82mm","10mm","<?=yundan_add_all($rs,'s')?>");//收件地址
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");

LODOP.ADD_PRINT_TEXT("92mm","89mm","25mm","7mm","<?=cadd($rs['s_add_chengshi'])?><?=cadd($mrs['add_chengshi'])?>"); //收货城市
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.ADD_PRINT_TEXT("97mm","40mm","25mm","7mm","<?=Country($rs['country'],'','EN')?>"); //收货国家
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);

LODOP.ADD_PRINT_TEXT("75mm","37mm","35mm","7mm","<?=cadd($rs['s_mobile_code'])?>-<?=cadd($rs['s_mobile'])?>");//收件电话
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("75mm","100mm","15mm","7mm","<?=cadd($rs['s_zip'])?>");//收件邮编
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
...
LODOP.ADD_PRINT_TEXT("120.9mm","99mm","12mm","10mm","<?=spr($rs['declarevalue'])?>");   //物品价值
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("120.9mm","114mm","8mm","10mm","$");   //物品价值单位
...
LODOP.ADD_PRINT_TEXT("134mm","141mm","7mm","5mm","<?=DateYmd(time(),'m')?>");//	时间月

LODOP.ADD_PRINT_TEXT("134mm","151mm","7mm","5mm","<?=DateYmd(time(),'d')?>");//	时间日
