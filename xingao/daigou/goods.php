...
//前/后配置
if($dgid){$rs=FeData('daigou','*',"dgid='{$dgid}' {$Xwh}");$groupid=FeData('member','groupid',"userid='{$rs['userid']}'");}
$userid=$rs['userid']?$rs['userid']:$_SESSION['DGuserid'];
$username=$rs['username']?$rs['username']:$_SESSION['DGusername'];
$groupid=$groupid?$groupid:$_SESSION['DGgroupid'];
