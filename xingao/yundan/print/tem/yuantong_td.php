...
LODOP.PRINT_INITA("-3.2mm","-30mm","232mm","126mm","<?=yundan_print($print_tem)?>-圆通套打-吉买转运打印");
LODOP.SET_PRINT_PAGESIZE(1,2320,1260,"");//设置纸张高度宽度 (默认单位为0.1mm,如800=80mm)
LODOP.ADD_PRINT_SETUP_BKIMG("G:\yuantong_td.jpg");
...
LODOP.ADD_PRINT_TEXT("57mm","98mm","15mm","6.09mm","<?=CompanySend('sendZip')?>");//发件邮编
//LODOP.ADD_PRINT_TEXT("57mm","48mm","23mm","6.09mm","<?=CompanySend('sendTel')?>");//发件公司电话
LODOP.ADD_PRINT_TEXT("57mm","48mm","23mm","6.09mm","<?=cadd($rs['f_mobile'])?><?=cadd($mrf['mobile'])?>");//发件电话



LODOP.ADD_PRINT_TEXT("27mm","38mm","19mm","5mm","<?=cadd($rs['f_name'])?><?=cadd($mrf['truename'])?>");//发件名字
//LODOP.ADD_PRINT_TEXT("46mm","23mm","80mm","10mm","<?=CompanySend('sendAdd')?>");// 换行\n  发件公司地址
LODOP.ADD_PRINT_TEXT("46mm","30mm","80mm","10mm","<?=cadd($rs['f_add_dizhi'])?><?=cadd($mrf['add_dizhi'])?>");// 发件人发件地址




LODOP.ADD_PRINT_TEXT("98mm","66mm","23mm","6mm","<?php $r=CustomerService($rs['userid']);echo $r[0]."({$r[1]})";?>");//客服代表
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");

LODOP.ADD_PRINT_TEXT("72mm","98mm","18mm","7mm","<?=spr($rs['weight'],2,0,1).$XAwt?>");  //总重量
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
//LODOP.ADD_PRINT_TEXT("105mm","105mm","23mm","10mm","<?=spr($rs['payment']+$rs['tax_payment'])?>元");//总费用
LODOP.SET_PRINT_STYLEA(0,"FontSize",13);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("28mm","136mm","25mm","6mm","<?=cadd($rs['s_name'])?>");//收件人
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("45mm","120mm","81mm","11mm","<?=yundan_add_all($rs,'s')?>");//收件地址
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
...
LODOP.ADD_PRINT_TEXT("57mm","141mm","28.84mm","4.76mm","<?=cadd($rs['s_mobile_code'])?>-<?=cadd($rs['s_mobile'])?>");//收件电话
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
LODOP.ADD_PRINT_TEXT("58mm","196mm","14mm","6mm","<?=cadd($rs['s_zip'])?>");//收件邮编
...
LODOP.ADD_PRINT_TEXT("100mm","88mm","9mm","5.03mm","<?=DateYmd(time(),'Y')?>");//	时间年
LODOP.ADD_PRINT_TEXT("100mm","95mm","6.35mm","4.76mm","<?=DateYmd(time(),'m')?>");//	时间月
LODOP.ADD_PRINT_TEXT("100mm","100mm","6.35mm","4.5mm","<?=DateYmd(time(),'d')?>");//	时间日
...
?>
LODOP.ADD_PRINT_TEXT("<?=$location?>mm","30mm","34mm","6.56mm","<?=cadd($wp['wupin_name'])?>");// 寄送物品
